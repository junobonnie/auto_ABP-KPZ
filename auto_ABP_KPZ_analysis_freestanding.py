...
def main(i):
    ...
    os.system('pypy3 ABP_KPZ_analysis_freestanding.py %d %d %03d %d'%(width, height, i, time_cut))
...
if __name__=='__main__':
    ...
    for i in range(1, sum(num_list)+1):
        with open('snapshots/' + str(width) + 'x' + str(height) + "/%03d/W1.txt"%(i), "r") as f:
            W_ = f.readlines()
    ...
    with open('snapshots/' + str(width) + 'x' + str(height) + "/W1.txt", "w") as f:
        for w in W:
            f.write(str(w)+"\n")
    with open('snapshots/' + str(width) + 'x' + str(height) + "/std_W1.txt", "w") as f:
        for std_w in std_W:
            f.write(str(std_w)+"\n")
    ...
    Hs = []
    for i in range(1, sum(num_list)+1):
        with open('snapshots/' + str(width) + 'x' + str(height) + "/%03d/H1.txt"%(i), "r") as f:
            H_ = f.readlines()
    ...
    with open('snapshots/' + str(width) + 'x' + str(height) + "/H1.txt", "w") as f:
        for h in H:
            f.write(str(h)+"\n")
    with open('snapshots/' + str(width) + 'x' + str(height) + "/std_H1.txt", "w") as f:
        for std_h in std_H:
            f.write(str(std_h)+"\n")
############################################################################################################
    Ws = []
    for i in range(1, sum(num_list)+1):
        with open('snapshots/' + str(width) + 'x' + str(height) + "/%03d/W2.txt"%(i), "r") as f:
            W_ = f.readlines()
            W_ = [float(w_) for w_ in W_]
            Ws.append(W_)
    ...
    W = np.mean(Ws, axis=0)
    std_W = np.std(Ws, axis=0)
    with open('snapshots/' + str(width) + 'x' + str(height) + "/W2.txt", "w") as f:
        for w in W:
            f.write(str(w)+"\n")
    with open('snapshots/' + str(width) + 'x' + str(height) + "/std_W2.txt", "w") as f:
        for std_w in std_W:
            f.write(str(std_w)+"\n")
    ...
    Hs = []
    for i in range(1, sum(num_list)+1):
        with open('snapshots/' + str(width) + 'x' + str(height) + "/%03d/H2.txt"%(i), "r") as f:
            H_ = f.readlines()
            H_ = [float(h_) for h_ in H_]
            Hs.append(H_)
    ...
    H = np.mean(Hs, axis=0)
    std_H = np.std(Hs, axis=0)
    with open('snapshots/' + str(width) + 'x' + str(height) + "/H2.txt", "w") as f:
        for h in H:
            f.write(str(h)+"\n")
    with open('snapshots/' + str(width) + 'x' + str(height) + "/std_H2.txt", "w") as f:
        for std_h in std_H:
            f.write(str(std_h)+"\n")
############################################################################################################
